...
private struct StoringArrayView: View {
    var code: String {
        return """
        extension Array: RawRepresentable where Element: Codable {
            public init?(rawValue: String) {
...
private struct User: Codable, Hashable {
    var name: String
    var age: Int
}

private struct StoringObjectArrayView: View {
    var code: String {
        return """
        struct User{
            var name: String
...
private struct StoringSimpleValueView: View {
    var code: String {
        return """
